...
async function setupABI2_0GCC(input: Input) {
  await $$`curl -fsSL --retry 3 -o gcc12-loong64-abi2.0.tar.xz https://github.com/loong64/cross-tools/releases/download/20250507/x86_64-cross-tools-loongarch64-unknown-linux-gnu-legacy.tar.xz ${String.raw`-H 'Authorization: Bearer ${input.github_token}'`}`
